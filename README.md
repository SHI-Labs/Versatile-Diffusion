...
You can also inference with float16 by adding a tag ```--fp16``` to each command. It doubles the running speed using a half size pretrained model (*vd-four-flow-v1-0-fp16.pth*). Below is an example command using float16:
